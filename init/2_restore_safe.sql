  ...
  CREATE UNIQUE INDEX "SAFE"."LISTASISSALUD__IDX" ON "SAFE"."LISTASISSALUD" ("SESION_SALUD_ID_SESION_SALUD")
  TABLESPACE "SAFE" ;
  ...
  CREATE UNIQUE INDEX "SAFE"."LISTTRABSALUD__IDX" ON "SAFE"."LISTTRABSALUD" ("CERTIFICADO_ID_CERTIFICADO")
  TABLESPACE "SAFE" ;
